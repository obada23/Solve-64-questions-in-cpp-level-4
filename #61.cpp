...
short countOverlapDays(stPeriod period1,stPeriod period2)
{
    ...
    else
    {
        while(true)
        {
            if
            (
                (checkIsDate1AfterThanDate2(period2.startDate,period1.startDate)||checkIsDate1EqualsToDate2(period2.startDate,period1.startDate))
                &&
                (checkIsDate1LessThanDate2(period2.startDate,period1.endDate) || checkIsDate1EqualsToDate2(period2.startDate,period1.endDate))
